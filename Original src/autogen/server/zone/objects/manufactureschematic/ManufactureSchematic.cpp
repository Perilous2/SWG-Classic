...
float ManufactureSchematic::getDataSize() const {
	ManufactureSchematicImplementation* _implementation = static_cast<ManufactureSchematicImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
float ManufactureSchematicImplementation::getDataSize() const{
	// server/zone/objects/manufactureschematic/ManufactureSchematic.idl():  		return dataSize;
	return dataSize;
}
...
float ManufactureSchematicAdapter::getDataSize() const {
	return (static_cast<ManufactureSchematic*>(stub))->getDataSize();
}
